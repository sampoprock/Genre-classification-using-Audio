...
color = ['red' if l==1 else 'green' if l==2 else 'blue' if l==3 else 'orange' if l==4 else 'yellow' if l==5 else 'cyan' for l in data['label']]

#for name in featureName:
   # feature[name] = feature[name].min()/(feature[name].max()-feature[name].min())
